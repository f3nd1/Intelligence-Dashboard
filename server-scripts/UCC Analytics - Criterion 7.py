...
Purpose:
    Return permission-aware live analytics foundations for EduTrust Criterion 7.
...
POLICY_REGISTRY = {'7.1.1': {'title': 'Measurement of Outcomes', 'policy': 'PPD-SGL-SQ-7.1.1', 'version': '1.2'}}

SOURCE_CANDIDATES = {'quality_performance': ['Quality Performance Outcomes', 'Quality Performance Outcome'],
...
FILTER_FIELD_CANDIDATES = {'status': ['status', 'review_status', 'custom_status_updates'],
 'year': ['year', 'monitoring_year', 'academic_year'],
 'academic_year': ['academic_year', 'year', 'monitoring_year'],
...
CONFIG = {'7.1.1': {'sources': ['quality_performance',
           ...
           'metrics': [{'id': 'c711-outcomes',
                        'label': 'Performance outcomes in scope',
                        'source': 'quality_performance',
                        'mode': 'all'},
                       {'id': 'c711-categorised',
                        'label': 'Outcomes with a defined category',
                        'source': 'quality_performance',
                        'mode': 'truthy',
                        'field': ['outcome_category', 'category']},
                       {'id': 'c711-indicators',
                        'label': 'Outcomes with a KPI or indicator',
                        'source': 'quality_performance',
                        'mode': 'truthy',
                        'field': ['indicator', 'kpi', 'metric']},
                       {'id': 'c711-benchmarks',
                        'label': 'Outcomes with a benchmark',
                        'source': 'quality_performance',
                        'mode': 'truthy',
                        'field': ['benchmark', 'benchmark_value', 'benchmark_type']},
                       {'id': 'c711-targets',
                        'label': 'Outcomes with a target',
                        'source': 'quality_performance',
                        'mode': 'truthy',
                        'field': ['target', 'target_value']},
                       {'id': 'c711-actuals',
                        'label': 'Outcomes with an actual result',
                        'source': 'quality_performance',
                        'mode': 'truthy',
                        'field': ['actual', 'actual_value', 'current_value']},
                       {'id': 'c711-target-achieved',
                        'label': 'Outcomes meeting or exceeding target',
                        'source': 'quality_performance',
                        'mode': 'field_compare',
                        'field': ['actual', 'actual_value', 'current_value'],
                        'compare_field': ['target', 'target_value'],
                        'operator': 'gte'},
                       {'id': 'c711-below-target',
                        'label': 'Outcomes below target',
                        'source': 'quality_performance',
                        'mode': 'field_compare',
                        'field': ['actual', 'actual_value', 'current_value'],
                        'compare_field': ['target', 'target_value'],
                        'operator': 'lt'},
                       {'id': 'c711-measured',
                        'label': 'Outcomes with a measurement date',
                        'source': 'quality_performance',
                        'mode': 'truthy',
                        'field': ['measurement_date', 'date', 'review_date']},
                       {'id': 'c711-owned',
                        'label': 'Outcomes with an assigned owner',
                        'source': 'quality_performance',
                        'mode': 'truthy',
                        'field': ['owner', 'responsible', 'assigned_to']},
                       {'id': 'c711-quality-actions',
                        'label': 'Quality Actions supporting improvement',
                        'source': 'quality_action',
                        'mode': 'all'},
                       {'id': 'c711-open-actions',
                        'label': 'Open improvement actions',
                        'source': 'quality_action',
                        'mode': 'not_in',
                        'field': ['custom_status_updates', 'status'],
                        'values': ['Completed', 'Closed']},
                       {'id': 'c711-quality-meetings',
                        'label': 'Quality Meetings reviewing outcomes',
                       ...
                       {'id': 'c711-management-reviews',
                        ...
                        'mode': 'all'},
                       {'id': 'c711-net-saving',
                        'label': 'Total operational net saving',
                        'source': 'operational_outcomes',
                        'mode': 'sum',
                        'field': ['total_net_saving'],
                        'unit': 'SGD'},
                       {'id': 'c711-benchmark-variance',
                        'label': 'Total variance to benchmark',
                        'source': 'operational_outcomes',
                        'mode': 'sum',
                        'field': ['variance_to_benchmark'],
                        'unit': 'SGD'},
                       {'id': 'c711-trend-validity',
                        'label': 'Validated trend and comparative-data coverage',
                        'source': 'quality_performance',
                        'mode': 'unsupported',
                        'message': 'The approved trend-history and benchmark-validation child-table fields were not '
                                   'supplied.'}]}}

QUESTION_REGISTRY = {'7.1.1': [{'id': 'q711-1', 'question': 'How many performance outcomes are in scope?', 'metric_id': 'c711-outcomes'},
           {'id': 'q711-2',
            'question': 'How many outcomes meet or exceed their target?',
            'metric_id': 'c711-target-achieved'},
           {'id': 'q711-3', 'question': 'How many outcomes are below target?', 'metric_id': 'c711-below-target'},
           {'id': 'q711-4',
            'question': 'How many open improvement actions support outcome gaps?',
            'metric_id': 'c711-open-actions'},
           {'id': 'q711-5', 'question': 'What is the total operational net saving?', 'metric_id': 'c711-net-saving'}]}

EXCEPTION_METRIC_IDS = ['c711-below-target', 'c711-open-actions', 'c711-trend-validity']
...
result = {
    ...
    "warnings": ['Criterion 7 uses the Quality Performance Outcomes DocType as the primary policy source.',
 'Target-achievement metrics require numeric actual and target fields.',
 'Trend-history validation remains unsupported until the child-table structure is supplied.']
}
